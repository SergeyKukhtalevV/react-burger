  ...
  return (
    <main className={styles.container}>
      <ul className={styles.menu}>
        ...
        <li>
          <NavLink to={"/profile/orders"} className={`${styles.link} text text_type_main-medium`}>История заказов</NavLink>
        </li>
        <li>
      ...
      <form className={`${styles.form}`}>
        ...
        <EmailInput extraClass={`mt-6`} placeholder={'E-mail'} value={form.email} name={"email"} onChange={onChange} icon={"EditIcon"}/>
